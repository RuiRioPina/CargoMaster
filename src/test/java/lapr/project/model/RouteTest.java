...
public class RouteTest {
    ...
    public void setUp() throws Exception {
        ...
        ShipDynamic dynamic6 = (new ShipDynamic("31/12/2020 17:02", new Location(42.92236, -66.97243), new Movement(12.5, 2.4, 358), "NA", "A"));
        ShipDynamic dynamic7 = (new ShipDynamic("31/12/2020 17:03", new Location(42.92236, -66.97243), new Movement(12.5, 2.4, 358), "NA", "A"));
        route.add(dynamic1);
        route.add(dynamic);
        route.add(dynamic2);
        route.add(dynamic3);
