...
/**
    ...
    public void testSize() {
        ...
        assertEquals("size should be = 10",arr.length, instance.size());
        
        BST<String> sInstance = new BST();
        assertEquals("size should be = 0",0, sInstance.size());
        sInstance.insert("A");
        assertEquals("size should be = 1",1, sInstance.size());
        sInstance.insert("B");
        assertEquals("size should be = 2",2, sInstance.size());
        sInstance.insert("A");
        assertEquals("size should be = 2",2, sInstance.size());
    }
