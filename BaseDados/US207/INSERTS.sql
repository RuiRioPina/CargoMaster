...
INSERT INTO Trip(idvehicle,idShipCaptain,idFleet,idChiefEletrical,startfacility,endfacility,startdatetrip,enddatetrip) VALUES(1,2,1,1,13012,18476,'2020-01-01','2020-03-03');
INSERT INTO tripfacility(idtrip,codefacility,arrivaldate,departuredate)VALUES(2,13012,'2019-12-31','2020-01-01');
INSERT INTO tripfacility(idtrip,codefacility,arrivaldate,departuredate)VALUES(2,17386,'2020-02-02','2020-02-04');
INSERT INTO tripfacility(idtrip,codefacility,arrivaldate,departuredate)VALUES(2,18476,'2020-03-03','2020-03-05');
INSERT INTO MANIFEST(idtrip,codefacility,grossweight,typeManifest,dateManifest)VALUES(2,13012,10,'load','2020-01-01');
INSERT INTO MANIFEST(idtrip,codefacility,grossweight,typeManifest,dateManifest)VALUES(2,17386,50,'offload','2020-02-02');
INSERT INTO MANIFEST(idtrip,codefacility,grossweight,typeManifest,dateManifest)VALUES(2,17386,45,'load','2020-02-04');
INSERT INTO MANIFEST(idtrip,codefacility,grossweight,typeManifest,dateManifest)VALUES(2,18476,95,'offload','2020-03-03');
INSERT INTO containerManifest(nrContainer,idmanifest,idposition) VALUES('CBCU2123456',5,1);
INSERT INTO containerManifest(nrContainer,idmanifest,idposition) VALUES('ABCU1113456',5,2);
INSERT INTO containerManifest(nrContainer,idmanifest,idposition) VALUES('ABCU1113456',6,2);
INSERT INTO containerManifest(nrContainer,idmanifest,idposition) VALUES('TVCU2124466',7,2);
INSERT INTO containerManifest(nrContainer,idmanifest,idposition) VALUES('XGCU2123466',7,3);
INSERT INTO containerManifest(nrContainer,idmanifest,idposition) VALUES('SSDU2124366',7,4);
INSERT INTO containerManifest(nrContainer,idmanifest,idposition) VALUES('FFAU2124566',7,5);
